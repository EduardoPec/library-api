...
import io.github.eduardopec.libraryapi.controller.dto.CadastroLivroDTO;
import io.github.eduardopec.libraryapi.controller.dto.ResultadoPesquisaLivroDTO;
import io.github.eduardopec.libraryapi.controller.mappers.LivroMapper;
import io.github.eduardopec.libraryapi.model.GeneroLivro;
import io.github.eduardopec.libraryapi.model.Livro;
import io.github.eduardopec.libraryapi.service.LivroService;
...
public class LivroController implements GenericController {
    ...
    @GetMapping("{id}")
    @PreAuthorize("hasAnyRole('OPERADOR', 'GERENTE')")
    @Operation(summary = "Obter Detalhes", description = "Retorna dados do livro pelo ID")
    @ApiResponses({
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('OPERADOR', 'GERENTE')")
    @Operation(summary = "Pesquisar", description = "Realiza a pesquisa de livros por parametros")
    @ApiResponses({
