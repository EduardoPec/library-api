...
import io.github.eduardopec.libraryapi.validator.AutorValidator;
...
public class AutorService {
    ...
    public List<Autor> pesquisaByExample(String nome, String nacionalidade) {
        ...
        Example<Autor> autorExemple = Example.of(autor, matcher);
        return repository.findAll(autorExemple);
    }
